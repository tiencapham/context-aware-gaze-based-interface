...
echo_and_run cd "/home/learnlab/catkin_ws_openface/src/vision_opencv/cv_bridge"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /home/learnlab/catkin_ws_openface/build/vision_opencv/cv_bridge \
    build --build-base "/home/learnlab/catkin_ws_openface/build/vision_opencv/cv_bridge" \
    install \
    --root="${DESTDIR-/}" \
