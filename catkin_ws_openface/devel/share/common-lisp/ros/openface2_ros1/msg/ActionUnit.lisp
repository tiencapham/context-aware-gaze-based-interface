...
(cl:defmethod cl:initialize-instance :after ((m <ActionUnit>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ActionUnit)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name openface2_ros1-msg:<ActionUnit> is deprecated: use openface2_ros1-msg:ActionUnit instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <ActionUnit>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader openface2_ros1-msg:name-val is deprecated.  Use openface2_ros1-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'presence-val :lambda-list '(m))
(cl:defmethod presence-val ((m <ActionUnit>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader openface2_ros1-msg:presence-val is deprecated.  Use openface2_ros1-msg:presence instead.")
  (presence m))

(cl:ensure-generic-function 'intensity-val :lambda-list '(m))
(cl:defmethod intensity-val ((m <ActionUnit>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader openface2_ros1-msg:intensity-val is deprecated.  Use openface2_ros1-msg:intensity instead.")
  (intensity m))
