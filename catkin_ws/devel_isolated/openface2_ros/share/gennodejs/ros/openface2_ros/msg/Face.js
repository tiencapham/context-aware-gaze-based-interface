...
class Face {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('head_pos')) {
        this.head_pos = initObj.head_pos
      }
      else {
        this.head_pos = new geometry_msgs.msg.Vector3();
      }
      if (initObj.hasOwnProperty('head_rpy')) {
        this.head_rpy = initObj.head_rpy
      }
      else {
        this.head_rpy = new geometry_msgs.msg.Vector3();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [head_pos]
    bufferOffset = geometry_msgs.msg.Vector3.serialize(obj.head_pos, buffer, bufferOffset);
    // Serialize message field [head_rpy]
    bufferOffset = geometry_msgs.msg.Vector3.serialize(obj.head_rpy, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [head_pos]
    data.head_pos = geometry_msgs.msg.Vector3.deserialize(buffer, bufferOffset);
    // Deserialize message field [head_rpy]
    data.head_rpy = geometry_msgs.msg.Vector3.deserialize(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.head_pos !== undefined) {
      resolved.head_pos = geometry_msgs.msg.Vector3.Resolve(msg.head_pos)
    }
    else {
      resolved.head_pos = new geometry_msgs.msg.Vector3()
    }

    if (msg.head_rpy !== undefined) {
      resolved.head_rpy = geometry_msgs.msg.Vector3.Resolve(msg.head_rpy)
    }
    else {
      resolved.head_rpy = new geometry_msgs.msg.Vector3()
    }
