...
"""autogenerated by genpy from vino_people_msgs/EmotionsStamped.msg. Do not edit."""
import codecs
import sys
...
class EmotionsStamped(genpy.Message):
  _md5sum = "79d7438de6ae9698889cbc6fd5a76dc8"
  _type = "vino_people_msgs/EmotionsStamped"
...
bool do_rectify
"""
  __slots__ = ['header','emotions']
  _slot_types = ['std_msgs/Header','vino_people_msgs/Emotion[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(EmotionsStamped, self).__init__(*args, **kwds)
