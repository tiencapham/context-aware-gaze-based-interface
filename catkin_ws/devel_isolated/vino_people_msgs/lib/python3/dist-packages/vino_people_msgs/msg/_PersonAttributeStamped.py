...
"""autogenerated by genpy from vino_people_msgs/PersonAttributeStamped.msg. Do not edit."""
import codecs
import sys
...
class PersonAttributeStamped(genpy.Message):
  _md5sum = "6aa29359e9c0c768b60bc56461367107"
  _type = "vino_people_msgs/PersonAttributeStamped"
...
"""
  ...
  _slot_types = ['std_msgs/Header','vino_people_msgs/PersonAttribute[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PersonAttributeStamped, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = vino_people_msgs.msg.PersonAttribute()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          val1.attribute = str[start:end].decode('utf-8', 'rosmsg')
        else:
