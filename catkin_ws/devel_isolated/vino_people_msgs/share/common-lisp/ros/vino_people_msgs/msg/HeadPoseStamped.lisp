...
(cl:defclass <HeadPoseStamped> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass HeadPoseStamped (<HeadPoseStamped>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <HeadPoseStamped>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'HeadPoseStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vino_people_msgs-msg:<HeadPoseStamped> is deprecated: use vino_people_msgs-msg:HeadPoseStamped instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <HeadPoseStamped>))
...
(cl:defmethod headposes-val ((m <HeadPoseStamped>))
  ...
  (headposes m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <HeadPoseStamped>) ostream)
  "Serializes a message object of type '<HeadPoseStamped>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <HeadPoseStamped>) istream)
  "Deserializes a message object of type '<HeadPoseStamped>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<HeadPoseStamped>)))
  "Returns string type for a message object of type '<HeadPoseStamped>"
  "vino_people_msgs/HeadPoseStamped")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'HeadPoseStamped)))
  "Returns string type for a message object of type 'HeadPoseStamped"
  "vino_people_msgs/HeadPoseStamped")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<HeadPoseStamped>)))
  "Returns md5sum for a message object of type '<HeadPoseStamped>"
  "cc41b1252a051a958d6665b3c4977461")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'HeadPoseStamped)))
  "Returns md5sum for a message object of type 'HeadPoseStamped"
  "cc41b1252a051a958d6665b3c4977461")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<HeadPoseStamped>)))
  "Returns full string definition for message of type '<HeadPoseStamped>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'HeadPoseStamped)))
  "Returns full string definition for message of type 'HeadPoseStamped"
  (cl:format cl:nil "# Copyright (c) 2018 Intel Corporation~%#~%# Licensed under the Apache License, Version 2.0 (the \"License\");~%# you may not use this file except in compliance with the License.~%# You may obtain a copy of the License at~%#~%#      http://www.apache.org/licenses/LICENSE-2.0~%#~%# Unless required by applicable law or agreed to in writing, software~%# distributed under the License is distributed on an \"AS IS\" BASIS,~%# WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.~%# See the License for the specific language governing permissions and~%# limitations under the License.~%~%std_msgs/Header header~%vino_people_msgs/HeadPose[] headposes~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: vino_people_msgs/HeadPose~%# Copyright (c) 2018 Intel Corporation~%#~%# Licensed under the Apache License, Version 2.0 (the \"License\");~%# you may not use this file except in compliance with the License.~%# You may obtain a copy of the License at~%#~%#      http://www.apache.org/licenses/LICENSE-2.0~%#~%# Unless required by applicable law or agreed to in writing, software~%# distributed under the License is distributed on an \"AS IS\" BASIS,~%# WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.~%# See the License for the specific language governing permissions and~%# limitations under the License.~%~%float32 yaw							# yaw~%float32 pitch						# pitch~%float32 roll						# roll~%sensor_msgs/RegionOfInterest roi 	# region of interest for a person's face~%================================================================================~%MSG: sensor_msgs/RegionOfInterest~%# This message is used to specify a region of interest within an image.~%#~%# When used to specify the ROI setting of the camera when the image was~%# taken, the height and width fields should either match the height and~%# width fields for the associated image; or height = width = 0~%# indicates that the full resolution image was captured.~%~%uint32 x_offset  # Leftmost pixel of the ROI~%                 # (0 if the ROI includes the left edge of the image)~%uint32 y_offset  # Topmost pixel of the ROI~%                 # (0 if the ROI includes the top edge of the image)~%uint32 height    # Height of ROI~%uint32 width     # Width of ROI~%~%# True if a distinct rectified ROI should be calculated from the \"raw\"~%# ROI in this message. Typically this should be False if the full image~%# is captured (ROI not used), and True if a subwindow is captured (ROI~%# used).~%bool do_rectify~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <HeadPoseStamped>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <HeadPoseStamped>))
  "Converts a ROS message object to a list"
  (cl:list 'HeadPoseStamped
