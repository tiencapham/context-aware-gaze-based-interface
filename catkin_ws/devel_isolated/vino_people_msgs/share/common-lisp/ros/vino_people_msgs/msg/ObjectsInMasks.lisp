...
(cl:defclass <ObjectsInMasks> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
   ...
   (objects_vector
    ...
    :type (cl:vector vino_people_msgs-msg:ObjectInMask)
   :initform (cl:make-array 0 :element-type 'vino_people_msgs-msg:ObjectInMask :initial-element (cl:make-instance 'vino_people_msgs-msg:ObjectInMask))))
)

(cl:defclass ObjectsInMasks (<ObjectsInMasks>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <ObjectsInMasks>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'ObjectsInMasks)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vino_people_msgs-msg:<ObjectsInMasks> is deprecated: use vino_people_msgs-msg:ObjectsInMasks instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ObjectsInMasks>))
...
(cl:defmethod objects_vector-val ((m <ObjectsInMasks>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vino_people_msgs-msg:objects_vector-val is deprecated.  Use vino_people_msgs-msg:objects_vector instead.")
  (objects_vector m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ObjectsInMasks>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ObjectsInMasks>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'objects_vector)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'vino_people_msgs-msg:ObjectInMask))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ObjectsInMasks>)))
  "Returns string type for a message object of type '<ObjectsInMasks>"
  "vino_people_msgs/ObjectsInMasks")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ObjectsInMasks)))
  "Returns string type for a message object of type 'ObjectsInMasks"
  "vino_people_msgs/ObjectsInMasks")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ObjectsInMasks>)))
  "Returns md5sum for a message object of type '<ObjectsInMasks>"
  "7c8f10593ff5c0e4919e7a9252d7fd8d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ObjectsInMasks)))
  "Returns md5sum for a message object of type 'ObjectsInMasks"
  "7c8f10593ff5c0e4919e7a9252d7fd8d")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ObjectsInMasks>)))
  "Returns full string definition for message of type '<ObjectsInMasks>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ObjectsInMasks)))
  "Returns full string definition for message of type 'ObjectsInMasks"
  (cl:format cl:nil "# Copyright (c) 2017 Intel Corporation~%#~%# Licensed under the Apache License, Version 2.0 (the \"License\");~%# you may not use this file except in compliance with the License.~%# You may obtain a copy of the License at~%#~%#      http://www.apache.org/licenses/LICENSE-2.0~%#~%# Unless required by applicable law or agreed to in writing, software~%# distributed under the License is distributed on an \"AS IS\" BASIS,~%# WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.~%# See the License for the specific language governing permissions and~%# limitations under the License.~%~%# This message can represent objects detected and their bounding-boxes in a frame~%std_msgs/Header header         	# timestamp in header is the time the sensor captured the raw data~%ObjectInMask[] objects_vector   # ObjectInBox array~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: vino_people_msgs/ObjectInMask~%# Copyright (c) 2017 Intel Corporation~%#~%# Licensed under the Apache License, Version 2.0 (the \"License\");~%# you may not use this file except in compliance with the License.~%# You may obtain a copy of the License at~%#~%#      http://www.apache.org/licenses/LICENSE-2.0~%#~%# Unless required by applicable law or agreed to in writing, software~%# distributed under the License is distributed on an \"AS IS\" BASIS,~%# WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.~%# See the License for the specific language governing permissions and~%# limitations under the License.~%~%# This message can represent a detected object and its region of interest~%string object_name  				# object name~%float32 probability 				# probability of detected object~%sensor_msgs/RegionOfInterest roi    # region of interest~%float32[] mask_array				# Instance mask as Image~%================================================================================~%MSG: sensor_msgs/RegionOfInterest~%# This message is used to specify a region of interest within an image.~%#~%# When used to specify the ROI setting of the camera when the image was~%# taken, the height and width fields should either match the height and~%# width fields for the associated image; or height = width = 0~%# indicates that the full resolution image was captured.~%~%uint32 x_offset  # Leftmost pixel of the ROI~%                 # (0 if the ROI includes the left edge of the image)~%uint32 y_offset  # Topmost pixel of the ROI~%                 # (0 if the ROI includes the top edge of the image)~%uint32 height    # Height of ROI~%uint32 width     # Width of ROI~%~%# True if a distinct rectified ROI should be calculated from the \"raw\"~%# ROI in this message. Typically this should be False if the full image~%# is captured (ROI not used), and True if a subwindow is captured (ROI~%# used).~%bool do_rectify~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ObjectsInMasks>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ObjectsInMasks>))
  "Converts a ROS message object to a list"
  (cl:list 'ObjectsInMasks
