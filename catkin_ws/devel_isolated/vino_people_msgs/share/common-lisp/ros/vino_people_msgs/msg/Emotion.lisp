...
(cl:defmethod cl:initialize-instance :after ((m <Emotion>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Emotion)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vino_people_msgs-msg:<Emotion> is deprecated: use vino_people_msgs-msg:Emotion instead.")))

(cl:ensure-generic-function 'emotion-val :lambda-list '(m))
(cl:defmethod emotion-val ((m <Emotion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vino_people_msgs-msg:emotion-val is deprecated.  Use vino_people_msgs-msg:emotion instead.")
  (emotion m))

(cl:ensure-generic-function 'roi-val :lambda-list '(m))
(cl:defmethod roi-val ((m <Emotion>))
