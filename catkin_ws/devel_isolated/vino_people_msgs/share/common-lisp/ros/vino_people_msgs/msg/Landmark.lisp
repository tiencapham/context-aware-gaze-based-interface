...
(cl:defclass <Landmark> (roslisp-msg-protocol:ros-message)
  ((landmark_points
    :reader landmark_points
    :initarg :landmark_points
...
(cl:defmethod cl:initialize-instance :after ((m <Landmark>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Landmark)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vino_people_msgs-msg:<Landmark> is deprecated: use vino_people_msgs-msg:Landmark instead.")))

(cl:ensure-generic-function 'landmark_points-val :lambda-list '(m))
(cl:defmethod landmark_points-val ((m <Landmark>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vino_people_msgs-msg:landmark_points-val is deprecated.  Use vino_people_msgs-msg:landmark_points instead.")
  (landmark_points m))

(cl:ensure-generic-function 'roi-val :lambda-list '(m))
(cl:defmethod roi-val ((m <Landmark>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Landmark>) ostream)
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'landmark_points))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (roslisp-msg-protocol:serialize ele ostream))
   (cl:slot-value msg 'landmark_points))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Landmark>) istream)
  ...
  (cl:setf (cl:slot-value msg 'landmark_points) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'landmark_points)))
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Landmark>))
  (cl:+ 0
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'landmark_points) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ (roslisp-msg-protocol:serialization-length ele))))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Landmark>))
  ...
  (cl:list 'Landmark
    (cl:cons ':landmark_points (landmark_points msg))
    (cl:cons ':roi (roi msg))
))
