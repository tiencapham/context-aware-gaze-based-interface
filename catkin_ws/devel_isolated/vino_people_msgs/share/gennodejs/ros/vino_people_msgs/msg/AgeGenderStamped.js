...
class AgeGenderStamped {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new AgeGenderStamped(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.objects[i] = AgeGender.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new AgeGenderStamped(null);
    ...
    if (msg.objects !== undefined) {
      ...
      for (let i = 0; i < resolved.objects.length; ++i) {
        resolved.objects[i] = AgeGender.Resolve(msg.objects[i]);
      }
    }
    else {
      resolved.objects = []
...
module.exports = AgeGenderStamped;
