...
class LicensePlate {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('license')) {
        this.license = initObj.license
      }
      else {
        this.license = '';
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [license]
    bufferOffset = _serializer.string(obj.license, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LicensePlate(null);
    // Deserialize message field [license]
    data.license = _deserializer.string(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    let length = 0;
    length += _getByteLength(object.license);
    return length + 21;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LicensePlate(null);
    if (msg.license !== undefined) {
      resolved.license = msg.license;
    }
    else {
      resolved.license = ''
    }
