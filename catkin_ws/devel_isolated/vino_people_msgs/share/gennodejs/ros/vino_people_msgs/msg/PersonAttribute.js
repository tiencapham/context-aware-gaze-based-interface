...
class PersonAttribute {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.string(obj.attribute, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PersonAttribute(null);
    // Deserialize message field [attribute]
    data.attribute = _deserializer.string(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    let length = 0;
    length += _getByteLength(object.attribute);
    return length + 21;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PersonAttribute(null);
...
module.exports = PersonAttribute;
