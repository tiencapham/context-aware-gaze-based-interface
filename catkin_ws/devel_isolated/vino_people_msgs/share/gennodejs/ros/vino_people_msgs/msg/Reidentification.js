...
class Reidentification {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('identity')) {
        this.identity = initObj.identity
      }
      else {
        this.identity = '';
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [identity]
    bufferOffset = _serializer.string(obj.identity, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Reidentification(null);
    // Deserialize message field [identity]
    data.identity = _deserializer.string(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    let length = 0;
    length += _getByteLength(object.identity);
    return length + 21;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Reidentification(null);
    if (msg.identity !== undefined) {
      resolved.identity = msg.identity;
    }
    else {
      resolved.identity = ''
    }
...
module.exports = Reidentification;
