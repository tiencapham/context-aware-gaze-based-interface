...
if("TRUE" STREQUAL "TRUE")
  set(cv_bridge_SOURCE_PREFIX /home/learnlab/catkin_ws/src/vision_opencv/cv_bridge)
  set(cv_bridge_DEVEL_PREFIX /home/learnlab/catkin_ws/devel)
  ...
  set(cv_bridge_INSTALL_PREFIX /home/learnlab/catkin_ws/install)
...
if(NOT "/home/learnlab/catkin_ws/src/vision_opencv/cv_bridge/include;/opt/intel/openvino_2021.4.752/opencv/include " STREQUAL " ")
  set(cv_bridge_INCLUDE_DIRS "")
  set(_include_dirs "/home/learnlab/catkin_ws/src/vision_opencv/cv_bridge/include;/opt/intel/openvino_2021.4.752/opencv/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/learnlab/catkin_ws/src/vision_opencv/cv_bridge/${idir}'.  ${_report}")
    endif()
    _list_append_unique(cv_bridge_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "cv_bridge;/opt/intel/openvino_2021/opencv/lib/libopencv_calib3d.so.4.5.3;/opt/intel/openvino_2021/opencv/lib/libopencv_dnn.so.4.5.3;/opt/intel/openvino_2021/opencv/lib/libopencv_features2d.so.4.5.3;/opt/intel/openvino_2021/opencv/lib/libopencv_flann.so.4.5.3;/opt/intel/openvino_2021/opencv/lib/libopencv_gapi.so.4.5.3;/opt/intel/openvino_2021/opencv/lib/libopencv_highgui.so.4.5.3;/opt/intel/openvino_2021/opencv/lib/libopencv_ml.so.4.5.3;/opt/intel/openvino_2021/opencv/lib/libopencv_objdetect.so.4.5.3;/opt/intel/openvino_2021/opencv/lib/libopencv_photo.so.4.5.3;/opt/intel/openvino_2021/opencv/lib/libopencv_stitching.so.4.5.3;/opt/intel/openvino_2021/opencv/lib/libopencv_video.so.4.5.3;/opt/intel/openvino_2021/opencv/lib/libopencv_videoio.so.4.5.3;/opt/intel/openvino_2021/opencv/lib/libopencv_core.so.4.5.3;/opt/intel/openvino_2021/opencv/lib/libopencv_imgproc.so.4.5.3;/opt/intel/openvino_2021/opencv/lib/libopencv_imgcodecs.so.4.5.3")
